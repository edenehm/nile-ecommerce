...
#Assumptions:
    ...
    #Users have two chances to log in correctly.
    #User login is whatever the user considers their first and last name to be and is not case-sensitive.
    ...
    #Only one shopper is shopping on Nile at any given time.  Two people cannot shop simultaneously.
